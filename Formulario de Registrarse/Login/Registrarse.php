...
if (isset($_POST['Usuario']) && isset($_POST['NombreCompleto']) && isset($_POST['Clave']) && isset($_POST['RClave'])) {
    ...
    if (empty($usuario)) {
        ...
        $sql = "SELECT * FROM usuarios1 WHERE NombreUsuario = '$usuario'";
        ...
        if (mysqli_num_rows($query) > 0) {
            ...
            $sql2 = "INSERT INTO usuarios1(NombreCompleto, NombreUsuario, Clave) VALUES ('$nombreCompleto','$usuario','$clave')";
